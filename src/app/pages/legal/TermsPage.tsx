        ...
        <Col lg={8} className="mx-auto">
          ...
          <div className="content">
            <section className="mb-5">
              ...
              <p>
                By accessing and using AL-SUK ("we," "our," or "us"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.
              </p>
            </section>
            ...
            <section className="mb-5">
              ...
              <p>
                Permission is granted to temporarily download one copy of the materials on AL-SUK for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
              </p>
              <ul>
                <li>modify or copy the materials</li>
                <li>use the materials for any commercial purpose or for any public display (commercial or non-commercial)</li>
                <li>attempt to decompile or reverse engineer any software contained on AL-SUK</li>
            ...
            <section className="mb-5">
              ...
              <p>
                In no event shall AL-SUK or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on AL-SUK, even if AL-SUK or an authorized representative has been notified orally or in writing of the possibility of such damage.
              </p>
            </section>
